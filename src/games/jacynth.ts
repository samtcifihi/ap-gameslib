...
export class JacynthGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>score>eog", "goal>area", "mechanic>place", "mechanic>network", "mechanic>hidden", "mechanic>random>setup", "mechanic>random>play", "board>shape>rect", "board>connect>rect", "components>decktet", "other>2+players"],
    ...
    public collectChatLogLine(lines: ChatLogLine[], r: APMoveResult, ctx: ChatLogCollectContext): boolean {
        switch (r.type) {
            case "place":
                ...
                return true;
            case "claim":
                this.pushSeatChatLine(lines, ctx.defaultSeat, "apresults:CLAIM.jacynth", {where: r.where!});
                return true;
            default:
