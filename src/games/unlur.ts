...
export class UnlurGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>connect", "mechanic>place", "mechanic>asymmetry", "board>shape>hex", "board>connect>hex", "components>simple>1per"],
    ...
    public collectChatLogLine(lines: ChatLogLine[], r: APMoveResult, ctx: ChatLogCollectContext): boolean {
        switch (r.type) {
            case "place":
                ...
                return true;
            case "pie":
                this.pushSeatChatLine(lines, ctx.defaultSeat, "apresults:PIE.unlur", {});
                return true;
            case "eog":
                if (r.reason === "foul") {
                this.pushNeutralChatLine(lines, "apresults:EOG.unlur_foul");
                } else {
