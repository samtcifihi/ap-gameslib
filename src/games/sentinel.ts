...
import { APRenderRep, MarkerGlyph } from "@abstractplay/renderer/build/schemas/schema";
import type { APMoveResult } from "../schemas/moveresults.js";
import { RectGrid, reviver, UserFacingError, Direction, allDirections } from "../common/index.js";
...
export class SentinelGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>annihilate", "goal>vigil", "mechanic>capture", "mechanic>move", "mechanic>move>sow", "mechanic>stack", "mechanic>vigil", "board>shape>rect", "board>connect>rect", "components>simple>1per"],
        flags: []
    };
