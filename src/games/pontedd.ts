...
import { IPoint, RectGrid, reviver, shuffle, SquareDiagGraph, SquareGraph, SquareOrthGraph, UserFacingError, cloneState } from "../common/index.js";
...
export class PonteDDGame extends GameBase {
    ...
    public load(idx = -1): PonteDDGame {
        ...
        this.bridges = cloneState(state.bridges) as [string,string][];
    ...
    public collectChatLogLine(lines: ChatLogLine[], r: APMoveResult, ctx: ChatLogCollectContext): boolean {
        switch (r.type) {
            case "place":
                ...
                return true;
            case "connect":
                this.pushSeatChatLine(lines, ctx.defaultSeat, "apresults:CONNECT.pontedd", {left: r.p1!, right: r.p2!});
                return true;
            default:
    ...
    public clone(): PonteDDGame {
        const cloned = Object.assign(new PonteDDGame(), cloneState(this) as PonteDDGame);
        return cloned;
    }
}
