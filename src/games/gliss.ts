...
import { DirectionCardinal, RectGrid, reviver, shuffle, SquareOrthGraph, UserFacingError, cloneState } from "../common/index.js";
...
export class GlissGame extends GameBase {
    ...
    public clone(): GlissGame {
        return Object.assign(new GlissGame(), cloneState(this) as GlissGame);
    }
}
