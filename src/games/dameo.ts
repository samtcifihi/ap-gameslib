...
export class DameoGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>annihilate", "goal>immobilize", "mechanic>capture", "mechanic>differentiate", "mechanic>move>group", "board>shape>rect", "board>connect>rect", "components>simple>1per"],
        flags: ["perspective", "automove", ]
    };

    public static clone(obj: DameoGame): DameoGame {

        const cloned = Object.assign(new DameoGame(), cloneState(obj) as DameoGame);
        return cloned;
    }
