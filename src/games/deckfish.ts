...
export class DeckfishGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>score>eog", "mechanic>move", "mechanic>place", "mechanic>random>setup", "mechanic>set", "mechanic>economy", "mechanic>displace", "board>shape>rect", "board>connect>rect", "components>decktet"],
