import {  GameBase, IAPGameState, IClickResult, IIndividualState, IRenderOpts, IStashEntry, IValidationResult, type ChatLogCollectContext, type ChatLogLine } from "./_base.js";
...
export class BlockadeGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>breakthrough", "mechanic>place", "mechanic>move", "mechanic>block", "mechanic>capture", "board>shape>rect", "board>connect>rect", "components>special"],
