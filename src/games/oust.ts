...
import { HexTriGraph, RectGrid, reviver, UserFacingError } from "../common/index.js";
...
export class OustGame extends GameBase {
    ...
    public sidebarScores(): IScores[] {
        ...
        return [
            { name: this.neutralAreaLabel("apgames:status.GROUPCOUNT"), scores: [groupSizes1.length, groupSizes2.length] },
