...
import {  GameBase, IAPGameState, IClickResult, IIndividualState, IValidationResult, IScores, IRenderOpts, type ChatLogCollectContext, type ChatLogLine } from "./_base.js";
