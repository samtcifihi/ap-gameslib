...
export class CourtGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>annihilate", "goal>cripple", "goal>immobilize", "mechanic>move", "mechanic>capture", "mechanic>differentiate", "board>shape>rect", "board>connect>rect", "components>simple>1per"],
        ...
        const rep: APRenderRep =  {
            ...
            legend: {
                ...
                B1: [{ name: "piece", colour: 1 },
                     { name: "chess-bishop-outline-traditional", colour: "#ffffff", scale: 0.6, opacity: 0.6, orientation: "vertical" }],
                B2: [{ name: "piece", colour: 2 },
                     { name: "chess-bishop-outline-traditional", colour: "#aaaaaa", scale: 0.6, opacity: 0.6, orientation: "vertical" }],
                N1: [{ name: "piece", colour: 1 },
                     { name: "chess-knight-outline-traditional", colour: "#ffffff", scale: 0.6, opacity: 0.6, orientation: "vertical" }],
                N2: [{ name: "piece", colour: 2 },
                     { name: "chess-knight-outline-traditional", colour: "#aaaaaa", scale: 0.6, opacity: 0.6, orientation: "vertical" }],
                R1: [{ name: "piece", colour: 1 },
                     { name: "chess-rook-outline-traditional",   colour: "#ffffff", scale: 0.6, opacity: 0.6, orientation: "vertical" }],
                R2: [{ name: "piece", colour: 2 },
                     { name: "chess-rook-outline-traditional",   colour: "#aaaaaa", scale: 0.6, opacity: 0.6, orientation: "vertical" }],
            },
            pieces: pstr
        };
    ...
    public collectChatLogLine(lines: ChatLogLine[], r: APMoveResult, ctx: ChatLogCollectContext): boolean {
        switch (r.type) {
            case "place":
                this.pushSeatChatLine(lines, ctx.defaultSeat, "apresults:PLACE.court", { where: r.where!, what: r.what! });
                return true;
            case "move":
                this.pushSeatChatLine(lines, ctx.defaultSeat, "apresults:MOVE.complete_one", { from: r.from!, to: r.to! });
                return true;
            case "eog":
