...
import { APRenderRep, MarkerEdge, MarkerLine, RowCol } from "@abstractplay/renderer/build/schemas/schema";
...
export class ConnectionsGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>arrange", "goal>connect", "mechanic>place", "board>shape>rect", "board>connect>rect", "components>special", "components>simple>pnp"],
        flags: ["pie"],
    };
