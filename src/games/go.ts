import { GameBase, IAPGameState, IClickResult, ICustomButton, IIndividualState, IScores, IRenderOpts, IValidationResult , type ChatLogCollectContext, type ChatLogLine} from "./_base.js";
...
export class GoGame extends GameBase {
    ...
    public clone(): GoGame {
        const cloned = Object.assign(new GoGame(), cloneState(this) as GoGame);
