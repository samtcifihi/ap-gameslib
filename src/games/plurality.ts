import { GameBase, IAPGameState, IClickResult, ICustomButton, IIndividualState, IValidationResult, IScores } from "./_base.js";
import type { APGamesInformation } from "../schemas/gameinfo.js";
import { APRenderRep, BoardBasic, MarkerDots, RowCol } from "@abstractplay/renderer/build/schemas/schema";
import type { APMoveResult } from "../schemas/moveresults.js";
import { reviver, UserFacingError, SquareOrthGraph } from "../common/index.js";
...
export class PluralityGame extends GameBase {
    ...
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>area", "mechanic>place", "mechanic>coopt", "mechanic>enclose", "board>shape>rect", "board>connect>rect", "components>simple>1per"],
        variants: [
    ...
    public validateMove(m: string): IValidationResult {
        ...
        if (this.isKomiTurn()) {
            if (m.length === 0) {
                ...
                result.valid = true;
                result.complete = -1;
                result.message = i18next.t("apgames:validation.plurality.INITIAL_SETUP");
                return result;
            }
