import { IAPGameState, IClickResult, IIndividualState, IRenderOpts, IScores, IValidationResult , type ChatLogCollectContext, type ChatLogLine} from "./_base.js";
...
export class PenteGame extends InARowBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>arrange", "goal>score>race", "mechanic>place", "mechanic>capture", "board>shape>rect", "board>connect>rect", "components>simple>1per"],
