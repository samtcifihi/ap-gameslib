...
import { RectGrid, Direction } from "../common/index.js";
...
import { TaflSettings } from "./tafl/settings.js";
...
export class TaflGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>royal-escape", "goal>royal-capture", "goal>immobilize", "mechanic>asymmetry", "mechanic>capture", "mechanic>differentiate", "mechanic>move", "other>traditional", "board>shape>rect", "board>connect>rect", "components>simple>1per"],
