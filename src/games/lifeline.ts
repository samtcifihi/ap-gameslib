...
export class LifelineGame extends GameBase {
    ...
    public static readonly gameinfo: APGamesInformation = {
        ...
        flags: ["pie"],
        categories: ["goal>annihilate", "mechanic>place", "mechanic>capture", "mechanic>enclose", "board>shape>hex", "board>connect>hex", "components>simple>1per"],
        variants: [
    ...
    public collectChatLogLine(lines: ChatLogLine[], r: APMoveResult, ctx: ChatLogCollectContext): boolean {
        switch (r.type) {
            case "place":
                ...
                return true;
            case "capture":
                this.pushNeutralChatLine(lines, "apresults:CAPTURE.lifeline", {where: r.where!});
                return true;
            default:
