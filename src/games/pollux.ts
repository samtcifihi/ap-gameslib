...
export class PolluxGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>connect", "goal>immobilize", "mechanic>place", "mechanic>move", "mechanic>block", "mechanic>differentiate", "board>shape>rect", "board>connect>hex", "components>simple>1per"],
        flags: ["automove"],
        variants: [
            { uid: "#board", }, // size-10
    ...
    public collectChatLogLine(lines: ChatLogLine[], r: APMoveResult, ctx: ChatLogCollectContext): boolean {
        switch (r.type) {
            case "move":
                ...
                return true;
            case "block":
                this.pushSeatChatLine(lines, ctx.defaultSeat, "apresults:PLACE.pollux", { where: r.where! });
                return true;
            case "eog":
