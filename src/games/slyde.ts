...
export class SlydeGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>score>eog", "mechanic>move", "mechanic>coopt", "board>shape>rect", "board>connect>rect", "components>simple>3c"],
        flags: ["scores"],
    };
    ...
    public sidebarScores(): IScores[] {
        return [{
            name: this.neutralAreaLabel("apgames:status.GROUPSIZES"),
            scores: [
