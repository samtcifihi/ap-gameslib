...
export class GuerrillaGame extends GameBase {
    ...
    public static readonly gameinfo: APGamesInformation = {
        ...
        categories: ["goal>annihilate", "mechanic>place", "mechanic>move", "mechanic>capture", "mechanic>asymmetry", "mechanic>enclose", "board>shape>rect", "board>connect>rect", "components>simple>1per"],
        flags: [],
        variants: [
