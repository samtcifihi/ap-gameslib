...
* Arimaa: New move entry. Click a piece and the square it should end your turn on, and the engine works out the steps, pushes and pulls included. Moves are now recorded in Lightvector notation, which names pieces and where they finish; older move strings are still read, so existing games are unaffected. A drawing that cannot be played says why: the opponent's piece, a boxed-in or frozen piece, a rabbit sent backward, or arrows that fit alone but not together.
